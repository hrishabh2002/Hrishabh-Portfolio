...
const Timeline = () => {
    return (
        <VerticalTimeline>
            ...
            >
                <h3 className="vertical-timeline-element-title mb-4">Bachelors of technology - Computer science and engineering</h3>
            </VerticalTimelineElement>
            <VerticalTimelineElement
                className="vertical-timeline-element--education"
                date="2018 - 2019"
                ...
                icon={<FontAwesomeIcon size="2x" icon={faGraduationCap} className="timeline-grad-icon" />}
            >
                <h3 className="vertical-timeline-element-title mb-4">Standard 12th</h3>
            </VerticalTimelineElement>
        </VerticalTimeline>
    )
}
