...
const Contact = () => {
  return (
    <>
      <CustomNav />
      <Container className="pt-lg-3 mb-3">
          ...
          <Col className="float-md-right text-right">
            ...
            <div className="mt-3 mb-3 pr-lg-5 pr-xs-3">
              <Button className="contact-btns bg-custom-blue mr-2 shadow border-0 py-1">
                <FontAwesomeIcon size="1x" icon={faPhoneAlt} /><span><a href="tel:+916394051760" className="text-link">Phone</a></span>
              </Button>
              <Button className="contact-btns bg-custom-blue mr-2 shadow border-0 py-1 px-2" onClick={() => window.open('mailto:hrishabhyadav96@gmail.com?subject="Hello !"', '_blank')}>
                <FontAwesomeIcon size="1x" icon={faEnvelope} /><span>Email</span>
              </Button>
              <Button className="contact-btns bg-custom-blue shadow border-0 py-1" onClick={() => window.open('https://www.linkedin.com/in/hrishabh-yadav-a53a611ba/', '_blank')}>
